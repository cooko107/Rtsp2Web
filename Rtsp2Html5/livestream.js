...
// 	{name: "cam2", rtsp: "rtsp://admin:xiolift123@192.168.13.106/h264/ch1/main/av_stream"}
// ];
...
var liveStream = function (req, resp) {                                            // handle each client request by instantiating a new FFMPEG instance
    ...
    console.log(reqUrl)
    console.log(reqUrl.query.url)
    rtspUrl = reqUrl.query.url
    cameras = [{name: "cam2", rtsp: rtspUrl}]
